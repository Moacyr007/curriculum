...
const sobreMim =
  "Sou um desenvolvedor de software fullstack, graduado em Ciência da Computação pela UFMT com sólido conhecimento em .Net e C#, também possui experiência com Razor e Angular. Sempre trabalho pensando na qualidade e em resolver o problema proposto, independente da tecnologia. Também possuo experiência profissional em arquitetura microsserviços e monotilo nas linguagens C# e Java. Frameworks .Net e Spring. Banco de dados Postgresql, SqlServer, MongoDb, Elasticsearch, Redis. Desenvolvimento de pipelines de CI/CD com deply Serviço de Kubernetes do Azure (AKS). Experiência com docker, testes unitários e de integração, messageria utilizando RabbitMQ e Apigateway com Ocelot.";

const aboutMe =
  "I am a fullstack software developer, graduated in Computer Science at UFMT(Federal University of Mato Grosso) with solid knowledge in .Net and C#, I also have experience with Razor and Angular. I'm always working with code quality in mind and focus on solving the problem on hand, regardless of technology.. I also have professional experience in microservices and monotile architecture in C# and Java languages. .Net and Spring frameworks. Postgresql database, SqlServer, MongoDb, Elasticsearch, Redis. Development of CI/CD pipelines with Azure Kubernetes Service (AKS) deply. Experience with Docker, unit and integration testing, messaging using RabbitMQ and Apigateway with Ocelot.";
