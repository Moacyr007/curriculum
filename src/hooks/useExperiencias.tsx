...
const experiencias: Experience[] = [
  {
    ...
    location: 'Remoto',
    description: [
      'Atualmente alocado no IBGE (Instituto Brasileiro de Geografia e Estatística) como Desenvolvedor .NET Fullstack Sênior desde novembro de 2024. Desenvolvimento e manutenção de aplicações utilizando .NET, bancos de dados Oracle, com forte atuação em tecnologias geoespaciais, OpenLayers e jQuery.',
...
const experiences: Experience[] = [
  {
    ...
    "location": "Remote",
    "description": [
      "Currently allocated at IBGE (Brazilian Institute of Geography and Statistics) as a Senior .NET Fullstack Developer since November 2024. Working on the development and maintenance of applications using .NET, Oracle databases, with strong involvement in geospatial technologies, OpenLayers, and jQuery.",
