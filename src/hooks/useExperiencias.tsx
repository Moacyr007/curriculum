...
const experiencias: Experience[] = [
  {
    ...
    description: [
      ...
      'Implementei uma melhoria de performance que eliminou problemas de timeout em consultas de grandes áreas geográficas, utilizando cache de dados, streaming para o OpenLayers e processamento em lotes, com melhoria significativa na performance geral da aplicação.',
...
const experiences: Experience[] = [
  {
    ...
    "description": [
      ...
      "Implemented a performance improvement that eliminated timeout issues when querying large geographic areas, using data caching, streaming to OpenLayers, and batch processing, with significant overall performance gains.",
